...
// aIf it does, return the corrected phone number as a string ie. '02078834982' with no whitespace or special characters, else return "Not a phone number".

function isItANum(str) {
    str=str.replace(/[^0-9]/gi,'')
    return str.length!==11 && str.charAt(0) !== 0 ?'Not a phone number':str
}
